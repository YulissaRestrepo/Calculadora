...
class CalculadoraTest extends TestCase
{
    ...
    */
    ...
    {
        $calculadora = new Calculadora();
       //$this->assertEquals(1, $calculadora -> restar(3,3));
    ...
    */
    ...
    {
        $calculadora = new Calculadora();
        //$this->assertEquals(0, $calculadora -> multiplicar(3,3));
    ...
    */
    ...
    {
        $calculadora = new Calculadora();
        //$this->assertContains(2, $calculadora->generarArreglo());
        //$this->assertCount(1, $calculadora->generarArreglo());
